                        ...
                        <div class="col-lg-4 col-md-6">
                            <div class="single-product">
                                <div class="product-img">
                                    <img class="card-img" src="admin/upload/<?php echo $value['image_produk']?>"
                                        alt="" />
                                    <div class="p_icon">
                                        <a href="detail_produk.php?id=<?php echo $value['id_produk']?>">
                                            <i class="fa fa-eye"></i>
                                        </a>
                                        <a href="cart.php">
                                ...
                                <div class="product-btm">
                                    <a href="#" class="d-block">
                                        <h4 style="font-size:14px;"><?php echo $value['nama_produk']?></h4>
                                    </a>
                                    <div class="mt-3">
